...
UIAlertController * view=   [UIAlertController
   ...
   UIAlertAction* hd = [UIAlertAction actionWithTitle:@"HD" style:UIAlertActionStyleDefault
  ...
  UIAlertAction* sd = [UIAlertAction actionWithTitle:@"SD" style:UIAlertActionStyleDefault
                        handler:^(UIAlertAction * action)
                        {
 ...
 UIAlertAction* cc = [UIAlertAction actionWithTitle:@"Cancel" style:UIAlertActionStyleDefault
                        handler:^(UIAlertAction * action)
                        {
                           [view dismissViewControllerAnimated:YES completion:nil];
